...
import 'package:farm_recorder_api_client/src/api_util.dart';
import 'package:farm_recorder_api_client/src/model/location.dart';
...
class LocationsApi {
  ...
  Future<Response<BuiltList<Location>>> apiV1LocationsGet({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> apiV1LocationsIdDelete({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/locations/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Location>> apiV1LocationsIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [Location] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Location>> apiV1LocationsPost({ 
    Location? location,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _bodyData = location == null ? null : _serializers.serialize(location, specifiedType: _type);
