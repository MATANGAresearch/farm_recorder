...
import 'package:farm_recorder_api_client/src/model/product.dart';
...
class ProductsApi {
  ...
  Future<Response<BuiltList<Product>>> apiV1ProductsGet({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Product>> apiV1ProductsIdGet({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/products/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Product] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Product>> apiV1ProductsPost({ 
    Product? product,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      ...
      _bodyData = product == null ? null : _serializers.serialize(product, specifiedType: _type);
