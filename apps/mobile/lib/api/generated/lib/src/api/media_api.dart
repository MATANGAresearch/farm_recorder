...
class MediaApi {
  ...
  Future<Response<BuiltList<Media>>> apiV1MediaActivityActivityLogIdGet({ 
    ...
    final _path = r'/api/v1/media/activity/{activityLogId}'.replaceAll('{' r'activityLogId' '}', encodeQueryParameter(_serializers, activityLogId, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Media>> apiV1MediaPost({ 
    Media? media,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    try {
      const _type = FullType(Media);
      _bodyData = media == null ? null : _serializers.serialize(media, specifiedType: _type);
