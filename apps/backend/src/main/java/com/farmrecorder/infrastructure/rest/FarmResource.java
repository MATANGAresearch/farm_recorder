...
public class FarmResource {
    ...
    public List<String> getAssignedWorkers(@PathParam("farmId") UUID farmId) {
    ...
    public Response assignWorker(@PathParam("farmId") UUID farmId, @PathParam("email") String email) {
